...
In its raw form, the dataset only needs minimal formatting before we can start modeling. GRE, CGPA and TOEFL are already continuous and don't need transformation. For university rating, statement of purpose, and letter of recommendation strength, these variables were converted into ordinal variables to properly characterize their categorial nature. The presence of research was recoded as a proper binary variable. 
